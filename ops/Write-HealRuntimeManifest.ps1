...
$manifest = [ordered]@{
    ...
    components = @(
        ...
        [ordered]@{ logicalComponent = "legacy-rsid"; code = "app/services/heal-rsid-resolution and legacy matcher/enrichment"; data = "data/legacy-rsid and data/runs"; config = "HEAL_RSID_RESOLUTION_ROOT"; start = "HEAL-only n8n workflows or API fallback"; health = "legacy canon/match smoke test"; logs = "logs/api"; retention = "active resolution protected"; support = "legacy-rsid" },
    ...
    sharedDependencies = @("Docker Desktop image store", "n8n shared application/database", "Node.js", "Python", "cloudflared")
